...
class StudySpotPopup extends StatefulWidget {
  ...
  @override
  StudySpotPopupState createState() => StudySpotPopupState();
}

class StudySpotPopupState extends State<StudySpotPopup> {
  ...
  Future<void> _loadRatings() async {
    ...
    try {
      final ratings =
          await _studySpotService.getAllRatingsForSpot(widget.studySpot['id']);
      final userEntry =
      ...
      final avg = await _studySpotService
          .getStudySpotAverageRating(widget.studySpot['id']);
      setState(() {
        _averageRating = avg;
      });
      debugPrint(
          'Loaded ratings: userRating=$_userRating, averageRating=$_averageRating');
    } catch (e, stackTrace) {
  ...
  Future<void> _submitRating(int rating) async {
    ...
    try {
      debugPrint(
          "Submitting rating: $rating for studySpot ID: ${widget.studySpot['id']}");
      await _studySpotService.rateStudySpot(
          widget.studySpot['id'], userId, rating);
  ...
  Widget _buildRatingSection() => Center(
        child: Column(
              ...
              children: List.generate(5, (index) {
                ...
                return IconButton(
                  ...
                  onPressed: _isSubmitting
                      ...
                      : () {
                          debugPrint(
                              'Star pressed. Submitting rating: $starIndex');
  ...
  Widget build(BuildContext context) {
    ...
    final dialogHeight =
        screenSize.height * 0.75; // slightly taller than before
